...
\section{Markova izvēles procesi} \label{chap:mdp}
...
\subsubsection{Modeļa aproksimācija}
...
Stratēģijas aproksimācijas algoritmi tiek tuvāk apskatīti \ref{chap:stim}
nodaļā.
...
\section{Stimulētā mācīšanās} \label{chap:stim}
...
vienādojumiem ir apskatītas nodaļā \ref{chap:mdp} Šajā nodaļā tiek pievērsta
...
\section{CCACLA algoritms}\label{chap:ccacla}
...
Nodaļā tiek sniegts īss ieskats tālāk aprakstītajos eksperimentos~\ref{chap:exp}
...
\section{Veiktie eksperimenti un rezultāti}\label{chap:exp}
