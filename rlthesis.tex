...
\recenzents{Juris Smotrovs, Dr.dat.}
\vieta{Rīga}
\gads{2016}
...
\begin{abstract-lv}
  ...
  \keywords{stimulētā mācīšanās; neironu tīkli; Markova izvēles procesi;
    nepārtrauktas telpas.}
\end{abstract-lv}
\clearpage
...
\begin{abstract-en}
  ...
  \keywords{reinforcement learning; artificial neural networks; Markov decision
    processes; continuous spaces.}
\end{abstract-en}
\clearpage
% \specnodala{Autoreferāts}
\begin{abstract-auto}
% \textbf{Autoreferāts}

Darbā tiek ieviesti trīs jauni stimulētās mācīšanās algoritmi, ko autors
apvieno zem kopīgā nosaukuma CCACLA. Darbā šie algoritmi tiek eksperimentāli
salīdzināti ar CACLA algoritmu, uz kā tie ir balstīti, parādot to pārākumu
dažādos aspektos.

Darbā ir apskatīts liels stimulētās mācīšanās un mašīnmācīšanās literatūras
apjoms. Darba izpētes posmā tika apskatīta arī citu zinātnisko nozaru
literatūra, galvenokārt neirozinātnes. Absolūti lielāko daļu apskatītās
literatūras veido zinātniskie raksti, tomēr tiek arī izmantotas grāmatas un
nepublicēti darbi, piemēram, doktora disertācijas.

Darba teorētisko daļu sastāda CCACLA algoritmu izstrāde, un tā praktisko daļu
veido CACLA un CCACLA algoritmu eksperimentālais salīdzinājums. Darba
teorētiskās un praktiskās daļas bāzes izstrāde aizņēma 8 mēnešus, paralēli
veicot literatūras izpēti. Literatūras izpēte tika veikta arī, gatavojoties
teorētiskās un praktiskās daļas  izstrādei, tomēr tās apjomu grūti novērtēt
objektīvi. Darbā tiek iekļauta arī autora kursa darbā veiktās stimulētās
mācīšanās un CACLA algoritma izpētes rezultātā gūtie secinājumi un literatūras
apskats.

Darba mērķos neietilpa precīza literatūrā sastopamo CACLA algoritma rezultātu
reproducēšana veiktajos eksperimentos. Tika pētītas CCACLA un CACLA atšķirības
pēc iespējas līdzīgos apstākļos. Neskatoties uz to, iegūtie rezultāti CACLA
algoritmam ir salīdzināmi ar literatūrā atrodamajiem, kā arī tiek parādīts,
ka atsevišķos gadījumos CCACLA algoritms pārspēj ar CACLA darbā sasniegtos
rezultātus. Ar darba rezultātiem plašāka publika vēl nav iepazīstināta.

Darba tekstam tika veikta pareizrakstības kļūdu pārbaude. Ortogrāfijas kļūdas
tika novērstas un labotas, izmantojot \textit{Hunspell} pakotni ar
\textit{LibreOffice} piedāvātajām latviešu valodas vārdnīcām. Interpunkcijas
kļūdas tika izskaustas, rūpīgi pārlasot tekstu, un ņemot talkā līdzcilvēkus.
Darba struktūra atbilst Latvijas Universitātes Datorikas fakultātes Maģistra darba
metodisko materiālu trešās nodaļas prasībām.

Darbā visas idejas, formulējumi un attēli, kas aizgūti no cietiem autoriem, ir
ar attiecīgām literatūras atsaucēm. Darbā ir aizgūts teksts no autora maģistra
kursa darba, kas tiek norādīts ar atsauci.
...
izmantot vairāklīmeņu neironu tīklus šo pazīmju izgūšanai. %TODO piemērs
...
izmantošanas trenēšanas procesā. %TODO: pārformulēt pēdējo teikumu.
...
% (visi apskatītie stimulētās mācīšanās uzdevumi ir epizodiski).
...
\begin{figure}
  ...
  \medskip
  \small
  Grafikos attēlots 10 CACLA algoritma instanču sniegums cart-pole uzdevumā.
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 100000 soļiem (katrā solī aģents saņem atalgojumu 1
  vai 0). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
  vidējā vērtība pa visām epohām līdz dotajai (\textit{cummulative mean}).
...
\begin{figure}
  ...
  \medskip
  \small
  Grafikos attēlots 7 CACLA-basic algoritma instanču sniegums cart-pole uzdevumā
  (3 instances ir atmestas, jo tiek uzskatītas par anomālijām).
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 100000 soļiem (katrā solī aģents saņem atalgojumu 1
  vai 0). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
...
\begin{figure}
  ...
  \caption{CCACLA ar stāvokļa paredzēšanu iegūtais atalgojums cart-pole uzdevumā}
  \medskip
  \small
  Grafikos attēlots 10 CACLA-state algoritma instanču sniegums cart-pole uzdevumā.
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 100000 soļiem (katrā solī aģents saņem atalgojumu 1
  vai 0). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
...
\begin{figure}
  ...
  \medskip
  \small
  Grafikos attēlots 10 CACLA-future algoritma instanču sniegums cart-pole uzdevumā.
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 100000 soļiem (katrā solī aģents saņem atalgojumu 1
  vai 0). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
...
\begin{figure}
  ...
  \medskip
  \small
  Grafikos attēlots visu apskatīto algoritmu instanču vidējais sniegums
  cart-pole uzdevumā, kā arī CACLA un CCACLA-future eksperimenti, kas tika
  darbināti ar 10 reizes augstāku mācīšanās ātruma parametra vērtību. Tie ir apzīmēti ar
  \textit{\_high} sufiksu. Kreisajā pusē redzama vidējā vērtība katrā treniņa epohā
  konkrētā algoritma instanču iegūtajam kopējam atalgojumam, kur treniņa epoha
  sastāv no 100000 soļiem (katrā solī aģents saņem atalgojumu 1 vai 0). Labajā
  pusē redzams šo pašu algoritmu vidējais iegūtais atalgojums solī, kur vidējā
  vērtība ņemta pār visiem soļiem epohā visām instancēm; tiek attēlota summārā
  vidējā vērtība pa visām epohām līdz dotajai (\textit{cummulative mean}).
\label{fig:pole-all}
\end{figure}
...
Arī CCACLA-future algoritmam acrobot vide sagādāja lielākas problēmas nekā
cart-pole. Toties, salīdzinot ar CACLA, vērojams, ka tam ir mazāka rezultātu
izkliede, un lielākā daļa eksperimenta instanču laika gaitā uzlabo rezultātus,
kas liecina par mācīšanos (attēls \ref{fig:acrobot-ccacla-future}).

CCACLA-state algoritmam vairāku eksperimenta instanču rezultātus nācās atmest,
...
izkliede nekā CACLA algoritmam (attēls \ref{fig:acrobot-ccacla-state}).
...
palielinātu trenēšanas laiku (šim un pārējiem acrobot eksperimentiem), tas netika
darīts.

Visu algoritmu kopējie rezultāti apskatāmi attēlā \ref{fig:acrobot-all}. Redzams,
...
novērotās mācīšanās problēmas. Kopumā jāsecina, ka neviens no algoritmiem līdz
derīgam mācīšanās rezultātam ar izmanto stāvokļu telpas izpētes shēmu
(normālsadalījuma trokšņa pievienošana izvēlētajām darbībām) nav spējīgs nonākt.
Mērķa stāvoklis tiek sasniegts tikai dažas reizes epohā.
...
\begin{figure}
  ...
  \medskip
  \small
  Grafikos attēlots 10 CACLA algoritma instanču sniegums acrobot uzdevumā.
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 50000 soļiem (katrā solī aģents saņem atalgojumu 0
  vai -1). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
  vidējā vērtība pa visām epohām līdz dotajai (\textit{cummulative mean}).
...
\begin{figure}
  ...
  \caption{CCACLA ar stāvokļa paredzēšanu iegūtais atalgojums acrobot uzdevumā}
  \medskip
  \small
  Grafikos attēlots 10 CCACLA-state algoritma instanču sniegums acrobot uzdevumā.
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 50000 soļiem (katrā solī aģents saņem atalgojumu 0
  vai -1). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
...
\begin{figure}
  ...
  \medskip
  \small
  Grafikos attēlots 10 CCACLA-future algoritma instanču sniegums acrobot uzdevumā.
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 50000 soļiem (katrā solī aģents saņem atalgojumu 0
  vai -1). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
...
\begin{figure}
  ...
  \small
  Grafikos attēlots visu apskatīto algoritmu instanču vidējais sniegums
  acrobot uzdevumā. Kreisajā pusē redzama vidējā vērtība katrā treniņa epohā
  konkrētā algoritma instanču iegūtajam kopējam atalgojumam, kur treniņa epoha
  sastāv no 50000 soļiem (katrā solī aģents saņem atalgojumu 0 vai -1). Labajā
  pusē redzams šo pašu algoritmu vidējais iegūtais atalgojums solī, kur vidējā
  vērtība ņemta pār visiem soļiem epohā visām instancēm; tiek attēlota summārā
  vidējā vērtība pa visām epohām līdz dotajai (\textit{cummulative mean}).
...
atalgojuma amplitūda, kas tika novērota secīgām eksperimenta epohām,
liktu domāt par mācīšanās diverģēšanu, tomēr, apskatot iegūtā atalgojuma
...
\ref{fig:car-all}. Arī šeit līdzīgi kā acrobot vidē jāsecina, ka algoritmi ar
izvēlēto izpētes shēmu nav spējīgi nonākt līdz derīgam rezultātam. Mērķa
stāvoklis tiek sasniegts tikai dažas reizes epohā.
...
\begin{figure}
  ...
  \medskip
  \small
  Grafikos attēlots 10 CACLA algoritma instanču sniegums mountain-car uzdevumā.
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 50000 soļiem (katrā solī aģents saņem atalgojumu 0
  vai -1). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
...
\begin{figure}
  ...
  \medskip
  \small
  Grafikos attēlots 10 CCACLA-basic algoritma instanču sniegums mountain-car uzdevumā.
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 50000 soļiem (katrā solī aģents saņem atalgojumu 0
  vai -1). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
...
\begin{figure}
  ...
  \caption{CCACLA ar stāvokļa paredzēšanu iegūtais atalgojums mountain car uzdevumā}
  \medskip
  \small
  Grafikos attēlots 10 CCACLA-state algoritma instanču sniegums mountain-car uzdevumā.
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 50000 soļiem (katrā solī aģents saņem atalgojumu 0
  vai -1). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
...
\begin{figure}
  ...
  \medskip
  \small
  Grafikos attēlots 10 CCACLA-future algoritma instanču sniegums mountain-car uzdevumā.
  Kreisajā pusē redzams katrā treniņa epohā kopā iegūtais atalgojums, kur
  treniņa epoha sastāv no 50000 soļiem (katrā solī aģents saņem atalgojumu 0
  vai -1). Labajā pusē redzams šo pašu instanču vidējais iegūtais atalgojums
  solī, kur vidējā vērtība ņemta pār visiem soļiem epohā; tiek attēlota summārā
...
\begin{figure}
  ...
  \small
  Grafikos attēlots visu apskatīto algoritmu instanču vidējais sniegums
  mountain-car uzdevumā. Kreisajā pusē redzama vidējā vērtība katrā treniņa epohā
  konkrētā algoritma instanču iegūtajam kopējam atalgojumam, kur treniņa epoha
  sastāv no 50000 soļiem (katrā solī aģents saņem atalgojumu 0 vai -1). Labajā
  pusē redzams šo pašu algoritmu vidējais iegūtais atalgojums solī, kur vidējā
  vērtība ņemta pār visiem soļiem epohā visām instancēm; tiek attēlota summārā
